...
[PluginActionId("com.mozahotkey.streamdeck.naturalinertia")]
public class NaturalInertiaAction : KeyAndEncoderBase
{
    ...
    public NaturalInertiaAction(ISDConnection connection, InitialPayload payload) : base(connection, payload)
    {
    ...
    private void UpdateDirectionIcon()
    {
        ...
        Connection.SetImageAsync($"Images/inertiaIcon{iconSuffix}.png");
    }
    ...
    public override void KeyPressed(KeyPayload payload)
    {
        ...
        catch (Exception ex)
        {
            ...
            Logger.Instance.LogMessage(TracingLevel.ERROR, $"Natural Inertia error: {ex.Message}");
        }
    }
    ...
    public override void DialRotate(DialRotatePayload payload)
    {
        ...
        {
            Logger.Instance.LogMessage(TracingLevel.ERROR, $"Natural Inertia dial error: {ex.Message}");
        }
    }
