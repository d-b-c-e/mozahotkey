...
[PluginActionId("com.mozahotkey.streamdeck.speeddamping")]
public class SpeedDampingAction : KeyAndEncoderBase
{
    ...
    public SpeedDampingAction(ISDConnection connection, InitialPayload payload) : base(connection, payload)
    {
    ...
    private async void InitializeDisplay()
    {
        try
        {
            ...
            {
                var currentValue = MozaDeviceManager.Instance.Device.GetSpeedDamping();
    ...
    private void UpdateDirectionIcon()
    {
        ...
        Connection.SetImageAsync($"Images/speedDampingIcon{iconSuffix}.png");
    }
    ...
    public override void KeyPressed(KeyPayload payload)
    {
        try
        {
            ...
            var newValue = device.AdjustSpeedDamping(delta);
        ...
        catch (Exception ex)
        {
            ...
            Logger.Instance.LogMessage(TracingLevel.ERROR, $"Speed Damping error: {ex.Message}");
        }
    }
    ...
    public override void DialRotate(DialRotatePayload payload)
    {
        ...
        {
            Logger.Instance.LogMessage(TracingLevel.ERROR, $"Speed Damping dial error: {ex.Message}");
        }
    }
