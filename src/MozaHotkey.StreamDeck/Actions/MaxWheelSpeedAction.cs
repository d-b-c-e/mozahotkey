...
[PluginActionId("com.mozahotkey.streamdeck.maxwheelspeed")]
public class MaxWheelSpeedAction : KeyAndEncoderBase
{
    ...
    private void UpdateDirectionIcon()
    {
        ...
        Connection.SetImageAsync($"Images/speedIcon{iconSuffix}.png");
    }
    ...
    public override void KeyPressed(KeyPayload payload)
    {
        try
        {
            ...
            var newValue = device.AdjustMaxWheelSpeed(delta);
        ...
        catch (Exception ex)
        {
            ...
            Logger.Instance.LogMessage(TracingLevel.ERROR, $"Max Wheel Speed error: {ex.Message}");
        }
    }
    ...
    public override void DialRotate(DialRotatePayload payload)
    {
        ...
        {
            Logger.Instance.LogMessage(TracingLevel.ERROR, $"Max Wheel Speed dial error: {ex.Message}");
        }
    }
