...
// Keep old UUID for backwards compatibility with existing user configurations
[PluginActionId("com.dbce.moza-streamdeck.naturaldampening")]
public class NaturalDampingAction : KeyAndEncoderBase
{
    ...
    public override void KeyPressed(KeyPayload payload)
    {
        ...
        catch (Exception ex)
        {
            ...
            Logger.Instance.LogMessage(TracingLevel.ERROR, $"Natural Damping error: {ex.Message}");
        }
    }
    ...
    public override void DialRotate(DialRotatePayload payload)
    {
        ...
        {
            Logger.Instance.LogMessage(TracingLevel.ERROR, $"Natural Damping dial error: {ex.Message}");
        }
    }
